...
def create_transaction():
    ...
    payload = {
        ...
        'ipn_url': 'http://your-domain.com/ipn',  # Set your public IPN URL
        'format': 'json'
    }
...
def ipn():
    ...
    # Here, you can update your database with the transaction status
    # ipn_data['status'] will contain the transaction status
    # ipn_data['txn_id'] will contain the transaction ID
